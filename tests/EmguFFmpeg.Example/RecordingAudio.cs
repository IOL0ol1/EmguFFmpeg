    ...
    public class RecordingAudio
    {
        ...
        public RecordingAudio(string outputFile, string inputDeviceName = null)
        {
            ...
            using (MediaWriter writer = new MediaWriter(outputFile))
            {
                ...
                writer.AddStream(MediaEncoder.CreateAudioEncode(writer.Format, stream.Codec.AVCodecContext.ch_layout.nb_channels, stream.Codec.AVCodecContext.sample_rate));
                writer.Initialize();
