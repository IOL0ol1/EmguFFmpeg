...
namespace FFmpeg.Sharp
{
    ...
    public static unsafe class MediaDevice
    {
        ...
        public static MediaDeviceInfoLists ListInputSources(MediaInputFormat value, string deviceName = null, MediaDictionary deviceOptions = null)
        {
            AVDeviceInfoList* @void = null;
            AVDeviceInfoList** o = &@void;
        ...
        public static MediaDeviceInfoLists ListOutputSinks(MediaOutputFormat value, string deviceName = null, MediaDictionary deviceOptions = null)
        {
            AVDeviceInfoList* @void = null;
            AVDeviceInfoList** o = &@void;
